...
public enum ResponseEnum {
    ...
    USER_NOT_FOUND(HttpStatus.BAD_REQUEST,
            ...
            "failed_login",
            "user_not_found"),
    KAFKA_TOPIC_NOT_FOUND(HttpStatus.BAD_REQUEST,
            "Kafka topic not found for %s.",
            "kafka_topic_not_found",
            "kafka_topic_not_found"),
    PROMO_CODE_NOT_FOUND(HttpStatus.BAD_REQUEST,
            "Promo code '%s' with payment methond '%s' not found.",
            "failed_promo",
            "promo_not_found"),
